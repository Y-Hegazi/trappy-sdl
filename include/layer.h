...
class Layer {
public:
  Layer(const std::string &name, int width, int height, int tileSizeW, int tileSizeH);
  ~Layer() = default;
  ...
  std::vector<std::shared_ptr<Platform>> getTilesInRect(const SDL_FRect &rect) const;
  ...
  void loadFromTMXLayer(const TMXParser::Layer &tmxLayer, 
